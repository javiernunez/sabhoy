...
const ARTICLE_HTML_BLOCK_CLASS =
  "article-html mb-6 whitespace-normal text-inherit [&_iframe]:aspect-video [&_iframe]:my-6 [&_iframe]:w-full [&_iframe]:max-w-full [&_img]:my-6 [&_img]:w-full [&_img]:max-w-full [&_img]:object-cover [&_a]:font-medium [&_a]:text-blue-700 [&_a]:underline [&_a]:decoration-blue-400/80 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-blue-900 hover:[&_a]:decoration-blue-600 [&_a_strong]:text-inherit [&_a_strong]:font-semibold [&_p]:mb-4 [&_p:last-child]:mb-0 [&_ul]:my-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:my-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_li]:my-1 [&_h2]:mt-8 [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:text-slate-900 [&_h3]:mt-7 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-slate-900 [&_h4]:mt-6 [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:text-slate-900 [&_blockquote]:my-6 [&_blockquote]:border-l-[3px] [&_blockquote]:border-slate-300 [&_blockquote]:pl-5 [&_blockquote]:italic [&_blockquote]:text-slate-700 [&_table]:my-6 [&_table]:w-full [&_th]:border [&_th]:border-slate-200 [&_th]:bg-slate-50 [&_th]:p-2 [&_th]:text-left [&_td]:border [&_td]:border-slate-200 [&_td]:p-2 [&_hr]:my-8 [&_hr]:border-slate-200";
